...
public class tc1GetAllEmployeeData extends TestBase {
	
	@BeforeClass
	public void setupGetRequest()
	{
		logger.info("&&&&&&&&& Started the first Test Case &&&&&&&&&&&&&");
	...
	{
		logger.info("End of the test case of getting all employee details ");
	}
}
